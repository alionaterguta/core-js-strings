...
concatenateStrings('hello', 'charlie');
/**
...
removeFirstOccurrences('To be or not to be', 'or');
/**
...
containsSubstring('The world is on fire', 'fire');
/**
...
function findLongestWord(sentence) {
  ...
  let max = splitedSentence[0];
  for (let i = 1; i < splitedSentence.length; i += 1) {
    if (splitedSentence[i].length > max.length) {
      max = splitedSentence[i];
    }
  }
  return max;
}
findLongestWord('Merry Christmas');
...
getStringFromTemplate('Angela', 'Lucky');
/**
